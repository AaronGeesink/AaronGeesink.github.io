...
const Skills = () => {
  const skills = [
    {
      category: 'Languages',
      items: ['C++', 'Python', 'Java', 'C#', 'JavaScript', 'HTML', 'CSS', 'Scala'],
    },
    {
      category: 'Libraries',
      items: ['React', 'NodeJS', 'ExpressJS', 'STL', 'scikit-learn'],
    },
    {
      category: 'Design',
      items: ['Figma', 'Visio'],
    },
    {
      ...
      items: ['Git', 'Unity', 'VSCode', 'QT', 'Maven', 'CMake'],
    },
    {
      category: 'Testing Tools',
      items: ['GoogleTest', 'Valgrind', 'Mocha', 'Chai', 'GCov'],
    }
  ];
  return (
